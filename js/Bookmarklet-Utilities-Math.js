...
HandHeldBookmarkletManagerTM.Utils.Math = function () {
	...
	myMath.distanceBetween = function ( point1, point2 ) {
	/* ( {}, {} ) -> num
	...
	*/
	...
	};  // End myMath.distanceBetween()


	myMath.degreesFromHorizontal = function ( point1, point2 ) {
	/* ( {}, {} ) -> num
	...
	*/
	...
	};  // End myMath.degreesFromHorizontal()

	return myMath;
};  // End HandHeldBookmarkletManagerTM.Utils.Math {}
