...
HandHeldBookmarkletManagerTM.utils.color = {

	rgbStrToNums: function ( rgb ) {
	/* ( str ) -> {}
	...
	*/
	...
	rgbNumsToHslNums: function ( rgbs ) {
	/* ( {} ) -> {}
...
};  // End HandHeldBookmarkletManagerTM.utils.color {}
